export class MultiContainerManagerUnoDos {
    ...
    async init() {
      ...
      this.injectStyles(parentContainer, "./stylesCreaUnContenedorDos.css");
    ...
    //   wrapper.setContent("Wrapper: Esta crazy.");
      ...
      // Inyectar los estilos
      this.injectStyles(wrapper, "./stylesCreaUnContenedorDos.css");
    ...
    //   child.setContent("child solarium  ");
      ...
      [child].forEach((child) => this.injectStyles(child, "./stylesCreaUnContenedorDos.css"));
