export class MultiContainerManagerTresUno {
    ...
    async init() {
      ...
      this.injectStyles(parentContainer, "./stylesCrea3contenedoresUno.css");
      ...
      // Inyectar los estilos
      this.injectStyles(wrapper, "./stylesCrea3contenedoresUno.css");
      ...
      [child].forEach((child) => this.injectStyles(child, "./stylesCrea3contenedoresUno.css"));
      ...
      [smallChild1, smallChild2, smallChild3].forEach((child) =>
        this.injectStyles(child, "./stylesCrea3contenedoresUno.css")
      );
