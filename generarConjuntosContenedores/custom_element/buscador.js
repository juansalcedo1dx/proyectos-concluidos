...
.input-container {
  ...
  .icon {
    ...
    left: 3.5rem; /* Espacio a la izquierda */
    display: flex;
    align-items: center;
  ...
  connectedCallback() {
    ...
    this.inputElement.addEventListener('focus', () => {
      ...
      this.containerElement.style.width = '17rem'; /* Más largo cuando está enfocado */
    });

    // Restaurar tamaño cuando se pierde el foco
    this.inputElement.addEventListener('blur', () => {
      this.containerElement.classList.remove('focused');
      this.containerElement.style.width = '15rem'; /* Mantener un tamaño más largo que el original */
    });
  }
}
