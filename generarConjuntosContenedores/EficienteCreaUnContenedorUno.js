export class MultiContainerManagerUnoUno {
    ...
    async init() {
      ...
      this.injectStyles(parentContainer, "./stylesUnContenedorUno.css");
    ...
    //   wrapper.setContent("Wrapper: Esta crazy.");
      ...
      // Inyectar los estilos
      this.injectStyles(wrapper, "./stylesUnContenedorUno.css");
    ...
    //   child.setContent("child solarium  ");
      ...
      [child].forEach((child) => this.injectStyles(child, "./stylesUnContenedorUno.css"));
