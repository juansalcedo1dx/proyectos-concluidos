export class MultiContainerManagerCuatroUno {
  ...
  async init() {
    ...
    this.injectStyles(parentContainer, [
      "./secciones/5_targetas/styles-celular.css",
      "./secciones/5_targetas/styles-tablet.css",
      "./secciones/5_targetas/styles-pc.css"
    ]);
    ...
    const smallChild4 = document.createElement("simple-container");  // Nuevo cuarto contenedor

    smallChild1.id = "small-child-1";
    smallChild2.id = "small-child-2";
    smallChild3.id = "small-child-3";
    smallChild4.id = "small-child-4";  // ID del nuevo cuarto contenedor
    ...
    if (mainContainer) {
      ...
      mainContainer.appendChild(smallChild4);  // Agregar el nuevo contenedor al "mainContainer"
    } else {
    ...
    await Promise.all([
      ...
      this.waitForShadowRoot(smallChild4),  // Esperar a que el cuarto contenedor esté listo
    ]);
    ...
    if (smallContainer1) {
      smallContainer1.appendChild(myButton1);
    } else {
    ...
    // Buscar el contenedor dentro del shadowRoot de smallChild3
    ...
    // Buscar el contenedor dentro del shadowRoot de smallChild4
    const smallContainer4 = smallChild4.shadowRoot.querySelector(".container");
    if (smallContainer4) {
      smallContainer4.appendChild(myButton4);  // Agregar el nuevo botón al cuarto contenedor
    } else {
