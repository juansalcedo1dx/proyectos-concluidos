        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .grid-container {
                    ...
                    grid-template-columns: repeat(auto-fill, minmax(14rem, 1fr)); /* Columnas auto-ajustables con un tamaño mínimo de 15rem */
...
customElements.define('seccion-1', CustomGridContainer);
