class Padre extends HTMLElement {
    ...
    render() {
        const smGridSize = this.getAttribute('sm') || '1x4';  // Default para pantallas móviles (sm) Si el ancho es menor o igual a 480px, se utiliza el layout sm.
        const mdGridSize = this.getAttribute('md') || '2x4';  // Default para pantallas medianas (md) Si el ancho es mayor a 480px pero menor o igual a 1024px, se utiliza el layout md.
        const lgGridSize = this.getAttribute('lg') || '3x4';  // Default para pantallas grandes (lg) Si el ancho es mayor a 1024px pero menor a 1440px, se utiliza el layout lg.
        const xlGridSize = this.getAttribute('xl') || '4x4';  // Default para pantallas extragrandes (xl) Si el ancho es mayor o igual a 1440px, se utiliza el layout xl.
...
customElements.define('seccion3-e', Padre);
